...
def svm_(x_train, x_test, y_train, y_test):
    ...
    svc_bestparam = SVC(probability=True, C=grid_result.best_params_['C'], gamma=grid_result.best_params_['gamma'], kernel=grid_result.best_params_['kernel'])
    ...
    filename = 'model/svm_classifier_prob.sav'
